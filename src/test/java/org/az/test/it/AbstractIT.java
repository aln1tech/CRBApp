...
import org.az.app.confRoomBook.App;
import org.az.app.confRoomBook.DBConfig;
import org.az.app.confRoomBook.model.IPersistable;
...
import org.az.test.util.ObjectPopulator;
...
@WebAppConfiguration
public abstract class AbstractIT<T> {
...
*/
    ...
    protected Object jsonToObject(String json) throws IOException {
        ...
        if (json!=null && json.substring(0,1).equals("[")) {
            ...
            try {
                result = this.jsonConverter.read(Response.class, mockHttpInputMessage);
            } catch (Exception e) {
                e.printStackTrace();
            }
            if (result == null) {
...
/*    protected T getTestEntity() {
    ...
    public String templateDeleteRequest(String url) throws Exception {
